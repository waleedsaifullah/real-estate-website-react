...
const Featured = () => {
    return (
        <div className='featured'>
            <h1 className='featured-text'>Tap Featured Listings</h1>
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        ...
                        <p>House for Sale</p>
                        <p className='price'>$12,767,000</p>
                    </div>
                    <div className='info-grid'>
                        ...
                        <div>
                            <div className='info'>
                                <p className='bold'>Square Feet:</p><p>8,134</p>
                            </div>
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>$14,456/month</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='span-2 right-img-details'>
                    <p>A beautiful and modern day home with full facilities like electricity, gas, and attached bathrooms.</p>
